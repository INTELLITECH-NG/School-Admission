...
<?php
 ...
 require 'db_params.php';
			  ...
			  $timi = mysql_query ("SELECT * FROM studentreg WHERE jamb = '$check'");
$rowtimer = mysql_fetch_assoc($timi);
if ($rowtimer['jamb'] != $check){
...
elseif ($rowtimer['status'] != $check1){
echo '<script type="text/javascript">
alert("The JAMB NUMBER you entered has not taken any Exam");
</script>';
?>
	...
	<script type="text/javascript">
				...
				<?php			
			            ...
			            $sql=mysql_query("SELECT * FROM studentreg WHERE jamb='$check'");
...
<tr><td align="right"><img height="40px" width="30px" src="logo.png" /></td><td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $template['title'] ?></b></td><td><a style="color:red" href="logo.php"><b>Logout</b></a></td></tr>

<table border="0px" width="100%"><br />
<tr><td width="100px" ><img height="110px" width="95px" src="rugipo.png" /></td><td valign="top" style="padding:10px; font-size:14px; text-align:center"><b  style="font-size:17px"><?php echo $template['title'] ?></b><br />
<span style=" font-size:15px;">(DIRECTORATE OF ACADEMIC AFFAIRS)</span><BR />
<b style="font-family:'Times New Roman', Times, serif;">Photo Card</b><br /><br />
<span style="font-family:'Times New Roman', Times, serif; font-size:11px; font-style:italic;">Your Secondary School Level is:</span> <b><?php echo $level; ?></b>
...
<table border="0px" width="100%">
<tr style="font-size:14px; font-weight:bold"><td width="170px">ADMISSION STATUS</td></tr>
<tr><td style="font-size:20px">
<?php 
if ($score1>='40'){
echo 'Congrat!!! Admission Successfully Granted.'; 
}else{
echo '...No Admission Granted...';
}
?></td></tr></tr>
