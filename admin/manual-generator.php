...
return true;
    ...
    <ul class="breadcrumb breadcrumb-top">
        <li>Dashboard</li>
        <li>Generate</li>
        <li><a href="">Manual Generator </a></li>
    </ul>
    <!-- END Blank Header -->
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Enter PIN (GLIXPIN + 4 Digits)</strong></h2>
                </div>
                ...
                <form name="form1" method="post" onSubmit="return check();" class="form-horizontal form-bordered">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="subname" name="subname" class="form-control" placeholder="Enter Pin Digits">
                            <input name="status" type="hidden" id="status" value="unused">
                            <span class="help-block">Please enter PIN NUMBER</span>
                        </div>
                    </div>
                    <div class="form-group form-actions">
                        <div class="col-md-9 col-md-offset-3">
                            <button type="submit" name="submit"  value="Generate" class="btn btn-sm btn-primary"><i class="fa fa-user"></i> Add</button>
